...
- **现有界面 audit → refine / Astryx 组件研究 / Light Rails 动效实验** → [`ui-patterns/interface-audit-refine-toolchain.md`](./ui-patterns/interface-audit-refine-toolchain.md)；Interfaces skills 管审计与修复，Astryx 只填明确组件缺口，Light Rails 只做许可隔离的单层 motion spike。
